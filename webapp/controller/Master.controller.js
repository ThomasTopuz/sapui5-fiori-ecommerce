sap.ui.define([
	...
	GroupHeaderListItem, Device, Fragment, formatter, MessageToast,
	Dialog, DialogType, Button, ButtonType, Text, models) {
	"use strict";

	return BaseController.extend("opensap.ecommerce.controller.Master", {
		...
		onInit: function () {
			...
			this.aGroupByCategorySorter = new Sorter({
				path: "Category",
				descending: false,
				group: true
			});
		...
		onOpenViewSettings: function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "opensap.ecommerce.view.ViewSettingsDialog",
					controller: this
		...
		onOpenCartPopover: function (oEvent) {
			...
			if (!this._pPopover) {
				this._pPopover = Fragment.load({
					id: oView.getId(),
					name: "opensap.ecommerce.view.cartPopover",
					controller: this
		...
		onNavToCartPage: function () {
			// usa full screen
			this.getRouter().navTo("cart");
			this.getModel("appView").setProperty("/layout", "OneColumn");
		},
		onToggleCategoryGrouping: function (oEvent) {
			var oList = this.byId("list");
			var oSorter = null;
			if (oEvent.getSource().getPressed()) {
				oSorter = this.aGroupByCategorySorter;
			} else {
				oSorter = [];
			}
